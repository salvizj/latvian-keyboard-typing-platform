    ...
    return (
        <DefaultPanel>
            <div className="flex flex-col gap-4 justify-center items-start">
                <h1 className="text-3xl font-bold mb-8 text-center">{translate('sign_up', language)}</h1>
                <form onSubmit={handleSignUp} className="flex flex-col gap-4 w-full">
                    <label>{translate('email', language)}</label>
                    <input
                        type="email"
                        ...
                        required
                    />
                    <label>{translate('password', language)}</label>
                    <input
                        className="border p-2 w-full rounded-md bg-color-primary text-color-third placeholder-color-third text-md"
                        type="password"
                        ...
                        required
                    />
                    <label>{translate('confirm_password', language)}</label>
                    <input
                        className="border p-2 w-full rounded-md bg-color-primary text-color-third placeholder-color-third text-md"
                        type="password"
