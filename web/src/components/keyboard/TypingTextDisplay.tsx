...
const TypingTextDisplay: React.FC<TextDisplayProps> = ({ currentCorrectTextCharacterIndex }) => {
    ...
    return (
        <div className="flex justify-center items-center flex-wrap bg-color-third border border-primary p-6 w-[46rem] gap-1 overflow-hidden whitespace-normal break-words h-[160px]">
